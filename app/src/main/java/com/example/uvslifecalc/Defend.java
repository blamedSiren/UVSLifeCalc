...
public class Defend extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(findViewById(R.id.defend),
                (v, insets) -> {
        ...
        oUp.setOnClickListener(v ->{
            ...
            f += 1;
            if(f > Integer.parseInt(MainActivity.opp_max)){
                f = Integer.parseInt(MainActivity.opp_max);
            }
        ...
        mUp.setOnClickListener(v ->{
            ...
            f += 1;
            if(f > Integer.parseInt(MainActivity.me_max)){
                f = Integer.parseInt(MainActivity.me_max);
            }
        ...
        hB.setOnClickListener(v ->{
            ...
            mi -= Math.round((Double.parseDouble(damage.getText().toString()) / 2 ));
            m = String.valueOf(mi);
            Intent result = new Intent();
            result.putExtra(OPP_KEY, o);
            result.putExtra(ME_KEY, m);
        ...
        uB.setOnClickListener(v ->{
            ...
            String o = oH.getText().toString();
            int mi = Integer.parseInt(m);
            mi -= (Integer.parseInt(damage.getText().toString()));
            m = String.valueOf(mi);
            Intent result = new Intent();
            result.putExtra(OPP_KEY, o);
            result.putExtra(ME_KEY, m);
